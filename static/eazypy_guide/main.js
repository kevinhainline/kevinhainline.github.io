...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const navLabels = {
    ...
    s3:  'How the Fitting Works',
    s4:  'Setting Up Your Catalog',
    s5:  'EAZY Parameters',
    s6:  'Running a Fit: Step by Step',
    s7:  'chisq, lnp, & P(z)',
    s8:  'z_ml, z_best, z_raw_chisq, z_phot',
    s9:  'Priors',
    s10: 'Template Error Function',
    s11: 'Running standard_output',
    s12: 'The zout Table',
    s13: 'Zeropoint Corrections',
    s14: 'Template Sets',
    s15: 'Visualizing Results',
    s16: 'Common Pitfalls & Tips',
    s17: 'Internal Attributes Ref',
